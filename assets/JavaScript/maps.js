...
It allows the user to find all hotels in a given place, within a given country. 
It then displays markers for all the hotels returned, with on-click details for each hotel.
...
// Create the autocomplete object and associate it with the UI input control. Restrict the search to the default country, and to place type "cities".
